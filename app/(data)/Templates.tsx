export default  [
    {
        ...
        aiPrompt:'Give me 5 blog topic idea in bullet wise only based on give niche & outline and give me result',
    ...
    },
    {
        ...
        form: [
            {
                label: 'Enter description of code you want along with Programming Langauge and give output in code block',
                field: 'textarea',
    ...
    },
    {
        ...
        slug: 'explain-code',
        aiPrompt: 'Depends on user codeDescription explain code line by line and give output in code block',
        form: [
            {
    ...
    },
    {
        ...
        aiPrompt: 'Depends on user codeInput find bug in code and give solution and give output in code block ',
        form: [
            {
