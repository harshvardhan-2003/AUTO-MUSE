...
function FormSection({selectedTemplate, userFormInput, loading}:PROPS) {
  ...
  return (
    <div className='p-5 shadow-md border rounded-lg bg-black text-white'>
        {/* @ts-ignore */}
        <Image src={selectedTemplate?.icon} alt='icon' width={70} height={70} />
        <h2 className='font-bold text-2xl mb-2 text-primary text-white'>{selectedTemplate?.name}</h2>
